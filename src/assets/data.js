const Projects = [
    ...
    },
    {
        ...
        longDescription: "I create this project in order to practice React, i chose this challenge because it has interactivity and that allowed me to use the state of React",
        featured: true,
        Technologies: [
            {
                tech: "React",
    ...
    },
    {
        ...
        longDescription: "On this project i apply all my knowledge of backend and frontend (30/06/2002), trying to make a product that worth it",
        featured: true,
        Technologies: [
            {
                tech: "Node.js",
    ...
    },
    {
        ...
        longDescription: "I really apreciate this project because i made this project without any tutos, i broke my mind resolving the logic challenges. Rules are simple: with space shoot to enemies and boss, also avoid the bullets that the boss throw you. Not available on phones",
        featured: true,
        Technologies: [
            {
                tech: "Javascript",
    ...
    },
    {
        ...
        longDescription: "A project created drawing on canvas, i lerned this on https://developer.mozilla.org/es/. Then a create others games. Not available on phones",
        featured: false,
        Technologies: [
            {
                tech: "HTML",
    ...
    },
    {
        ...
        longDescription: "This is my first time with Javascriptm i saw this project at Platzi but i added this diffilculty modes. Rules: It has a sequence of colors, you have to wait  for the sequence and then click on them",
        featured: false,
        Technologies: [
            {
                tech: "HTML",
